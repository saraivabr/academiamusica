...
export default function Termos() {
  return (
    <LegalPage title="Termos de uso" updated="29 de julho de 2026">
      <h2>1. Objeto</h2>
      ...
      <h2>2. Conta e prévia criativa</h2>
      <p>O cadastro inicial exige e-mail válido e confirmado. Antes da compra, a plataforma pode oferecer uma prévia criativa sem áudio completo, composta por elementos como título, trecho de refrão, sentimento e direção musical. A prévia não consome créditos e não representa uma música final.</p>
      ...
      <h2>4. Projeto Música Presente e créditos</h2>
      <p>O Projeto Música Presente custa R$ 49,97 em pagamento único via Pix e concede 20 créditos musicais. Cada rodada paga reserva 2 créditos e pode entregar até 2 versões, totalizando 10 rodadas pagas e potencial de até 20 músicas. Uma entrega parcial devolve o crédito da versão não entregue; falhas técnicas anteriores à entrega devolvem o saldo reservado.</p>

      <h2>5. Histórico das músicas</h2>
      <p>As versões concluídas ficam disponíveis no repertório pessoal do usuário, com player e link de download, enquanto a plataforma permanecer disponível. Créditos comprados e recargas não expiram enquanto o acesso estiver disponível.</p>
