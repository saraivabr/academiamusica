...
export default function PurchaseConfirmation() {
  ...
  return <main className="status-page"><span className="status-icon success">✓</span><div className="eyebrow">PAGAMENTO CONFIRMADO • PRODUTOR IA LIBERADO</div><h1>Sua primeira música começa com uma conversa.</h1><p>Seu dispositivo está autorizado, o Produtor IA está disponível e suas 25 músicas foram liberadas. Guarde o código <strong>{orderId}</strong> para entrar novamente em outro aparelho.</p><div className="next-steps"><article><span>01</span><h2>Conte sua história</h2><p>Escreva ou fale do seu jeito. O Produtor IA organiza a direção com você.</p><a href="/biblioteca/gerador/">Começar a conversa →</a></article><article><span>02</span><h2>Entenda o método</h2><p>Veja o mapa completo para transformar suas favoritas em lançamentos.</p><a href="/academia/">Ver a jornada →</a></article><article><span>03</span><h2>Precisa de ajuda?</h2><p>Nosso atendimento pode orientar seus primeiros passos.</p><a href="/suporte/">Falar com o suporte →</a></article></div></main>;
}
