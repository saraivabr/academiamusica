...
export default function PurchaseConfirmation() {
  ...
  return <main className="status-page"><span className="status-icon success">✓</span><div className="eyebrow">PAGAMENTO CONFIRMADO</div><h1>Sua jornada começou.</h1><p>Seu pedido foi confirmado e este dispositivo já está autorizado. Guarde o código <strong>{orderId}</strong> para entrar novamente em outro aparelho.</p><div className="next-steps"><article><span>01</span><h2>Acesse a Academia</h2><p>Veja o mapa completo e entenda a ordem da jornada.</p><a href="/academia/">Ir para a Academia →</a></article><article><span>02</span><h2>Comece pela ideia</h2><p>Escolha a história, emoção ou tema da sua primeira música.</p><a href="/academia/comecar/">Começar agora →</a></article><article><span>03</span><h2>Precisa de ajuda?</h2><p>Nosso atendimento pode orientar seus primeiros passos.</p><a href="/suporte/">Falar com o suporte →</a></article></div></main>;
}
