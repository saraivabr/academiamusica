...
export default function PurchaseConfirmation() {
  ...
  return <main className="status-page"><span className="status-icon success">✓</span><div className="eyebrow">PAGAMENTO CONFIRMADO • 25 MÚSICAS LIBERADAS</div><h1>Você já pode começar a criar.</h1><p>Seu pedido foi confirmado, este dispositivo está autorizado e suas 25 músicas estão disponíveis. Guarde o código <strong>{orderId}</strong> para entrar novamente em outro aparelho.</p><div className="next-steps"><article><span>01</span><h2>Crie a primeira música</h2><p>Conte uma ideia, escolha o estilo e receba duas versões dentro do estúdio.</p><a href="/biblioteca/gerador/">Abrir o estúdio →</a></article><article><span>02</span><h2>Entenda o método</h2><p>Veja o mapa completo para transformar suas favoritas em lançamentos.</p><a href="/academia/">Ver a jornada →</a></article><article><span>03</span><h2>Precisa de ajuda?</h2><p>Nosso atendimento pode orientar seus primeiros passos.</p><a href="/suporte/">Falar com o suporte →</a></article></div></main>;
}
