  ...
  return (
    <AcademyShell title="Como usar" eyebrow="TUTORIAL DA PLATAFORMA">
      ...
      <div className="lesson-list">
        ...
        <LessonCard number="03" title="Confirme o uso dos créditos" text="Revise a direção antes de criar. Cada rodada paga mostra o custo e pode entregar até duas versões." time="3 min" href="/biblioteca/gerador" />
