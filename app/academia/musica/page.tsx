    ...
    <AcademyShell title="Crie sua música" eyebrow="TUTORIAL • ETAPA 01">
      <section className="module-intro accent">
        ...
        <div>
          ...
          <p>Conte o essencial, escolha emoção, estilo e voz e receba até duas versões em cada rodada paga.</p>
      ...
      <div className="lesson-list">
        ...
        <LessonCard number="04" title="Escute com atenção" text="Compare as versões da rodada observando refrão, emoção e arranjo antes de escolher." time="6 min" href="/biblioteca" />
